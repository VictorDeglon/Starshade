...
window.platforms = [
  ...
  { x: 488, y: 320, width: 100, height: 34 },
  { x: 997, y: 272, width: 226, height: 23 },
  { x: 1429, y: 256, width: 68, height: 21, melt: true, meltDelay: 22 },
  { x: 1661, y: 256, width: 213, height: 20 },
  { x: 2099, y: 285, width: 67, height: 21, ghost: true, ghostPeriod: 134, ghostOnRatio: 0.4434782608695652 },
  { x: 2396, y: 323, width: 130, height: 34 },
  { x: 2766, y: 394, width: 197, height: 45, ghost: true, ghostPeriod: 134, ghostOnRatio: 0.4434782608695652 },
  { x: 3197, y: 456, width: 129, height: 24, ghost: true, ghostPeriod: 134, ghostOnRatio: 0.4434782608695652 },
  ...
  { x: 4560, y: 512, width: 173, height: 13 },
  { x: 4967, y: 571, width: 122, height: 13 },
  { x: 5319, y: 612, width: 117, height: 27, melt: true, meltDelay: 22 },
  ...
  { x: 7138, y: 562, width: 85, height: 25 },
  { x: 7411, y: 507, width: 228, height: 34 },
  { x: 8039, y: 440, width: 87, height: 42 },
  { x: 8290, y: 440, width: 195, height: 33 },
  { x: 8655, y: 353, width: 205, height: 27 },
  { x: 9044, y: 286, width: 124, height: 39 },
  { x: 9574, y: 227, width: 60, height: 13 },
  { x: 10040, y: 169, width: 152, height: 25 },
  { x: 10356, y: 169, width: 264, height: 44 },
  { x: 11044, y: 152, width: 96, height: 38, melt: true, meltDelay: 22 },
  { x: 11365, y: 181, width: 64, height: 32, ghost: true, ghostPeriod: 134, ghostOnRatio: 0.4434782608695652 },
  { x: 11654, y: 213, width: 167, height: 23 },
